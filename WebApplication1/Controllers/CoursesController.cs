...
namespace WebApplication1.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CourseID,Title,Credits,DepartmentID,CreatedOn,ModifiedOn")] Course course)
        {
        ...
        public ActionResult Edit(
            [Bind(Include = "CourseID,Title,Credits,DepartmentID,CreatedOn,ModifiedOn")] 
            Course course)
        {
            if (ModelState.IsValid)
            {
